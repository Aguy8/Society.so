...
const TEMOIGNAGES = [
  { img: 'https://images.unsplash.com/photo-1531123897727-8f11ebb3a745?auto=format&fit=crop&w=400&q=80', n: 'Aminata K.', r: 'Directrice — ONG Hope Life CI', segment: 'ONG', segColor: '#0E47AB', segBg: '#E8EFFC', texte: 'Society nous a permis de professionnaliser notre collecte de fonds. Notre rapport annuel s\'écrit maintenant en 10 minutes. Nos bailleurs reçoivent les chiffres en temps réel et on a reçu 3 nouveaux financements grâce à notre page d\'impact.', gain: '+108 % de conversions dons' },
  { img: 'https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?auto=format&fit=crop&w=400&q=80', n: 'Awa K.', r: 'Présidente — Mutuelle des Femmes d\'Abobo', segment: 'Mutuelle', segColor: '#D4A75B', segBg: '#F6EDD8', texte: 'Avant Society, je passais mes week-ends à relancer 200 cotisantes sur WhatsApp. Aujourd\'hui, je suis le suivi en temps réel — et j\'ai du temps pour vraiment animer notre mutuelle et faire grandir notre réseau.', gain: '28 % → 4 % d\'impayés' },
  { img: 'https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&fit=crop&w=400&q=80', n: 'Kofi A.', r: 'Président — INPHB Alumni Network', segment: 'Alumni', segColor: '#166534', segBg: '#DCFCE7', texte: 'Notre réseau alumni de l\'INPHB comptait 12 000 diplômés mais personne ne se connaissait. Avec Society, on a reconstitué le réseau en 3 mois et lancé notre premier programme de mentorat.', gain: 'Gala 4x plus fréquenté' },
  ...
  { img: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=400&q=80', n: 'Jean-Marc O.', r: 'Fondateur — Club des Entrepreneurs d\'Abidjan', segment: 'Réseau Pro', segColor: '#0E47AB', segBg: '#E8EFFC', texte: 'J\'ai lancé mon club business sur Society et en 6 semaines, j\'avais 340 membres payants. Ma communauté LinkedIn avait 3 000 followers mais aucun revenu. La différence est totale.', gain: '340 membres payants en 6 semaines' },
  ...
  { img: 'https://images.unsplash.com/photo-1489424731084-a3d5bc15a39b?auto=format&fit=crop&w=400&q=80', n: 'Fatou M.', r: 'Fondatrice — Collectif Femmes Entrepreneurs', segment: 'Communauté', segColor: '#5C2E91', segBg: '#F3F0FF', texte: 'Je ne savais pas si mon groupe était une ONG ou un réseau pro. Society m\'a aidé à structurer, et 4 mois après, j\'ai officiellement créé mon association. Society était là dès le début.', gain: 'Structure créée en 4 mois' },
  { img: 'https://images.unsplash.com/photo-1548142813-c348350df52b?auto=format&fit=crop&w=400&q=80', n: 'Salimata B.', r: 'Trésorière — MUGEF-CI', segment: 'Mutuelle', segColor: '#D4A75B', segBg: '#F6EDD8', texte: 'On avait des conflits tous les mois sur les cotisations. Maintenant toutes nos membres voient leur solde en temps réel depuis leur téléphone. La confiance a été rétablie en quelques semaines.', gain: '0 conflit depuis 8 mois' },
]
    ...
    <div className="page">
      ...
      <section style={{ padding: '120px 64px 80px', background: '#F8F8F8' }}>
        <div className="container">
          ...
          <h1 style={{ fontSize: 100, marginTop: 28, lineHeight: 0.9, maxWidth: 900 }}>
            Ils ont<br />
            <span style={{ color: '#0E47AB' }}>transformé</span><br />
            leur communauté.
          </h1>
            ...
            {TEMOIGNAGES.map((t, i) => (
              <Reveal key={i} delay={i * 60} style={{ breakInside: 'avoid', marginBottom: 24, display: 'block' }}>
                <div className="hover-lift" style={{ padding: 32, background: 'white', borderRadius: 24, border: '1px solid #E5E5E5' }}>
                  ...
                  <p style={{ fontSize: 15, lineHeight: 1.7, color: '#3A3A3A', fontStyle: 'italic', margin: '0 0 20px' }}>« {t.texte} »</p>
