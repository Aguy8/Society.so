...
const PAYMENTS = [
  { n: 'Orange Money', region: 'CI, SN, ML, CM, BF', color: '#FF6600', emoji: '🟠' },
  { n: 'Wave', region: 'CI, SN, ML, BF', color: '#1B9AF7', emoji: '🔵' },
  { n: 'MTN MoMo', region: 'CI, GH, CM, RW', color: '#FFD700', emoji: '🟡' },
  { n: 'Moov Money (Flooz)', region: 'CI, BJ, NE', color: '#0095D9', emoji: '🔷' },
  { n: 'M-Pesa', region: 'KE, TZ, UG, RW', color: '#4CAF50', emoji: '🟢' },
  { n: 'Visa / Mastercard', region: 'International', color: '#1A1F71', emoji: '💳' },
]

const TOOLS = [
  { cat: 'Communication', icon: 'chat', color: '#25D366', items: ['WhatsApp Business', 'SMS Pro', 'Email Marketing', 'Notifications push'] },
  { cat: 'Productivité', icon: 'grid', color: '#0E47AB', items: ['Google Workspace', 'Microsoft 365', 'Notion', 'Trello'] },
  { cat: 'Comptabilité', icon: 'money', color: '#D4A75B', items: ['Export CSV/Excel', 'PDF automatique', 'API comptable', 'Rapports bailleurs'] },
  { cat: 'Marketing', icon: 'chart', color: '#5C2E91', items: ['Mailchimp', 'Analytics Society', 'Meta Ads pixel', 'Google Analytics'] },
]
        ...
        <div className="container">
          <div style={{ maxWidth: 900 }}>
            ...
            <h1 style={{ fontSize: 100, marginTop: 28, lineHeight: 0.9 }}>
              Connecté à tout<br />
              <span style={{ color: '#0E47AB' }}>ce que vous</span><br />
              utilisez déjà.
            </h1>
            <p style={{ fontSize: 20, marginTop: 32, maxWidth: 640, lineHeight: 1.5 }}>
              Mobile Money africain, outils productivité, passerelles de paiement international — Society s'intègre nativement avec votre écosystème existant.
            </p>
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: '80px 64px' }}>
        <div className="container">
          <Reveal>
            ...
            <h2 style={{ fontSize: 56, marginTop: 20, marginBottom: 48 }}>Le Mobile Money africain,<br />natif et sans friction.</h2>
          </Reveal>
            ...
            {PAYMENTS.map((p, i) => (
              <Reveal key={i} delay={i * 80} direction="scale">
                <div className="hover-lift" style={{ padding: 32, background: 'white', borderRadius: 24, border: '1px solid #E5E5E5' }}>
                  ...
                  <div style={{ fontWeight: 800, fontSize: 18, color: '#0a0a0a' }}>{p.n}</div>
      ...
      <section style={{ padding: '80px 64px', background: '#0a0a0a' }}>
        <div className="container">
          <Reveal>
            ...
            <h2 style={{ fontSize: 56, marginTop: 20, marginBottom: 56, color: 'white' }}>Connectez vos outils<br /><span style={{ color: '#D4A75B' }}>en quelques clics.</span></h2>
          </Reveal>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 64, alignItems: 'center' }}>
            <Reveal direction="left">
              ...
              <p style={{ fontSize: 17, marginTop: 20, lineHeight: 1.6 }}>
                Accédez aux données de votre communauté, automatisez vos flux, créez des intégrations sur mesure avec notre API REST documentée.
              </p>
            ...
            <Reveal direction="right">
              <div style={{ background: '#0a0a0a', borderRadius: 20, padding: 28, fontFamily: 'monospace' }}>
                <div style={{ fontSize: 12, color: '#6B6B6B', marginBottom: 16 }}>// Exemple — Récupérer les membres</div>
                {[
                  { color: '#9B59B6', text: 'GET' },
                  { color: '#3B82F6', text: ' /v1/communities/{id}/members' },
                ].map((l, i) => (
                ...
                <div style={{ marginTop: 20, background: '#1a1a1a', borderRadius: 12, padding: 20 }}>
                  <pre style={{ color: '#D4A75B', fontSize: 12, margin: 0 }}>{`{
  "data": [
