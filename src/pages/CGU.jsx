...
const Section = ({ num, title, children }) => (
  <div style={{ marginBottom: 56 }}>
    <div style={{ display: 'flex', alignItems: 'flex-start', gap: 20, marginBottom: 20 }}>
      <div style={{ width: 40, height: 40, borderRadius: 10, background: '#0E47AB', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, fontWeight: 900, fontSize: 14, color: 'white' }}>
        {num}
      </div>
    ...
    <div className="page">
      ...
      <section style={{ padding: '120px 64px 64px', background: '#0a0a0a' }}>
        <div className="container">
          <span style={{ fontSize: 13, fontWeight: 700, letterSpacing: '0.06em', color: '#D4A75B', display: 'block', marginBottom: 20 }}>CONDITIONS GENERALES D'UTILISATION</span>
          <h1 style={{ fontSize: 72, lineHeight: 0.92, color: 'white', fontWeight: 900, maxWidth: 800 }}>
            Conditions generales<br />
            <span style={{ color: '#D4A75B' }}>d'utilisation.</span>
          </h1>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '280px 1fr', gap: 64, alignItems: 'start' }}>
              ...
              <div style={{ padding: '28px', background: '#F8F8F8', borderRadius: 20, border: '1px solid #EBEBEB' }}>
                ...
                <div style={{ display: 'grid', gap: 4 }}>
                  {[
                    ...
                    <button key={i} style={{ padding: '8px 12px', background: 'none', border: 'none', cursor: 'pointer', textAlign: 'left', fontSize: 12, color: '#3A3A3A', borderRadius: 8, lineHeight: 1.4 }}>
                      {item}
                    </button>
                  ))}
                </div>
                <div style={{ marginTop: 24, paddingTop: 20, borderTop: '1px solid #EBEBEB' }}>
                  <NavLink to="/confidentialite" style={{ fontSize: 13, color: '#0E47AB', fontWeight: 600, textDecoration: 'none', display: 'block', marginBottom: 8 }}>
                    Politique de confidentialite →
                  </NavLink>
                  <NavLink to="/mentions-legales" style={{ fontSize: 13, color: '#0E47AB', fontWeight: 600, textDecoration: 'none' }}>
                    Mentions legales →
                  </NavLink>
                </div>
              </div>
            ...
            <div style={{ maxWidth: 680 }}>
              <Section num="1" title="Objet">
                <P>Les presentes Conditions Generales d'Utilisation ont pour objet de definir les modalites et conditions dans lesquelles Difero Fundry SARL (ci-apres « Society ») met a la disposition de ses utilisateurs la plateforme Society accessible a l'adresse <strong>society.ci</strong> et via les applications mobiles iOS et Android.</P>
              ...
              <Section num="10" title="Droit applicable et juridiction">
                ...
                <div style={{ marginTop: 24, padding: '20px 24px', background: '#F8F8F8', borderRadius: 16 }}>
                  ...
                  <div style={{ fontSize: 15, fontWeight: 700, color: '#0a0a0a' }}>legal@society.ci</div>
