...
export default function FeatureEvenements() {
  return (
    <div className="page">
      ...
      <section style={{ padding: '120px 64px 80px', background: 'linear-gradient(135deg, #0a0a0a 0%, #1a1a2e 100%)', position: 'relative', overflow: 'hidden' }}>
        <div style={{ position: 'absolute', top: -80, right: -80, width: 400, height: 400, borderRadius: '50%', background: '#0E47AB', opacity: 0.15, filter: 'blur(60px)' }} />
        <div className="container" style={{ position: 'relative', zIndex: 2 }}>
          ...
          <div style={{ display: 'inline-flex', padding: '8px 16px', background: 'rgba(14,71,171,0.3)', border: '1px solid rgba(14,71,171,0.5)', borderRadius: 999, marginBottom: 24 }}>
          ...
          <h1 style={{ fontSize: 88, lineHeight: 0.9, color: 'white', maxWidth: 900 }}>
            Événements<br /><span style={{ color: '#D4A75B' }}>& billetterie.</span>
          </h1>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 64 }}>
            <div>
              ...
              <div style={{ marginTop: 40, display: 'grid', gap: 24 }}>
                {[
                  { icon: 'calendar', color: '#0E47AB', t: 'Création en 3 étapes', d: 'Titre, date, lieu, places disponibles — votre événement est en ligne en moins de 3 minutes.' },
                  { icon: 'money', color: '#D4A75B', t: 'Billetterie intégrée', d: 'Billetterie payante ou gratuite, avec paiement Mobile Money. Les fonds arrivent directement sur votre compte Society.' },
                  { icon: 'check', color: '#166534', t: 'QR code de contrôle', d: 'Chaque participant reçoit un QR code unique. À l\'entrée, scannez avec votre téléphone — rapide, infalsifiable.' },
                  { icon: 'users', color: '#5C2E91', t: 'Gestion des présents', d: 'Liste des inscrits, des présents, des absences — consultable en temps réel depuis votre téléphone.' },
                  ...
                  <Reveal key={i} delay={i * 80}>
                    <div style={{ display: 'grid', gridTemplateColumns: '48px 1fr', gap: 16 }}>
                      ...
                      <div>
                        ...
                        <div style={{ fontSize: 14, color: '#3A3A3A', lineHeight: 1.55 }}>{f.d}</div>
                      </div>
                    </div>
                  </Reveal>
                ))}
            ...
            <Reveal direction="right">
              <div style={{ position: 'sticky', top: 120 }}>
                <div style={{ background: '#0a0a0a', borderRadius: 28, padding: 32, color: 'white' }}>
                  ...
                  <div style={{ display: 'flex', gap: 16, marginTop: 16, flexWrap: 'wrap' }}>
                    {[['📅', 'Samedi 15 Juin'], ['📍', 'Hôtel Ivoire, Abidjan'], ['🎫', '480 / 500 places']].map(([e, t], i) => (
                  ...
                  <div style={{ marginTop: 24, padding: '16px 20px', background: 'rgba(255,255,255,0.06)', borderRadius: 16, border: '1px solid rgba(255,255,255,0.1)' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 8 }}>
                      ...
                      <span style={{ fontWeight: 700, color: '#D4A75B' }}>480 / 500</span>
                    </div>
                    <div style={{ height: 6, background: 'rgba(255,255,255,0.1)', borderRadius: 999, overflow: 'hidden' }}>
                      <div style={{ width: '96%', height: '100%', background: '#D4A75B' }} />
                    </div>
                  ...
                  <div style={{ marginTop: 16, padding: '16px 20px', background: 'rgba(212,167,91,0.1)', borderRadius: 16, border: '1px solid rgba(212,167,91,0.2)' }}>
                    ...
                    <div style={{ fontSize: 32, fontWeight: 800, color: '#D4A75B', marginTop: 4 }}>16 800 000 <span style={{ fontSize: 14 }}>FCFA</span></div>
                  </div>
