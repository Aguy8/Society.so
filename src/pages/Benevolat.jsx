  ...
  return (
    <div className="page">
      ...
      <section style={{ position: 'relative', minHeight: 640, display: 'flex', alignItems: 'flex-end', padding: '0 64px 80px', overflow: 'hidden' }}>
        <div style={{ position: 'absolute', inset: 0, backgroundImage: 'url(/assets/fists.png)', backgroundSize: 'cover', backgroundPosition: 'center 30%' }} />
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 80, alignItems: 'center' }}>
            ...
            <div>
              <div style={{ borderRadius: 32, overflow: 'hidden', aspectRatio: '4/5', position: 'relative', boxShadow: '0 32px 64px rgba(0,0,0,0.15)' }}>
                <img src="/assets/hands_paper.jpg" style={{ width: '100%', height: '100%', objectFit: 'cover' }} alt="Bénévolat" />
